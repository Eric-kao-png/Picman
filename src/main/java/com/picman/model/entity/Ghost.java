...
public class Ghost {
    private final int spawnCol = GameConfig.GHOST_START_COL;
    private final int spawnRow = GameConfig.GHOST_START_ROW;
    private final GridPosition position = new GridPosition(spawnCol, spawnRow);
